      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Chennai, Tamil Nadu, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:yashvardhanjaiswal7105@gmail.com" className="d-block" >yashvardhanjaiswal7105@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:6291698042" className="d-block" >6291698042</a>
          </div>
        ...
        <p className="text-light">   @ 2024. yashvardhanjaiswal All rights reserved </p> 
        </Col>
        </Row>
